                    ...
                    <>
                        ...
                        {loading ? (
                            ...
                            <div className="bg-white rounded-2xl border border-slate-100 py-20 text-center px-4 shadow-sm">
                                ...
                                <p className="text-slate-400 text-sm">{user?.tier !== 'premium' ? 'Premium members get early access — upgrade to see listings first.' : "Check back soon for today's drop."}</p>
                            </div>
                        ) : (
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
